...
pub struct ColourTokens {{
    ...
    pub border_decorative: Rgba8,
    pub border_control: Rgba8,
    pub selection_indicator: Rgba8,
    pub action_primary_background: Rgba8,
    pub action_primary_foreground: Rgba8,
    pub action_quiet_hover: Rgba8,
...
fn generate_colour_constant(
    ...
    let fields = [
        ...
        ("surface_hover", "colour.surface.hover"),
        ("border_decorative", "colour.border.decorative"),
        ("border_control", "colour.border.control"),
        ("selection_indicator", "colour.selection.indicator"),
        (
            "action_primary_background",
            "colour.action.primary.background",
        ),
        (
            "action_primary_foreground",
            "colour.action.primary.foreground",
        ),
        ("action_quiet_hover", "colour.action.quiet.hover"),
        ...
        ("overlay_annotation", "colour.overlay.annotation"),
        ("overlay_selected", "colour.overlay.selected"),
        ("overlay_vertex", "colour.overlay.vertex"),
        ("overlay_footprint", "colour.overlay.footprint"),
