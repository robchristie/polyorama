...
test('hardware adapter evidence rejects missing and software identities', () => {
  assert.equal(hardwareAdapter({ available: true, vendor: 'nvidia', architecture: 'ampere', fallback: false }), true);
