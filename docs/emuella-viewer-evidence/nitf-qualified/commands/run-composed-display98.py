...
s=Path('/nvme/development/emuella/.build-targets/polyorama-proof');d=s/'nitf-final';b=d/'build';out=d/'composed-display98';out.mkdir(exist_ok=False)
env=dict(os.environ,DISPLAY=':98',LD_LIBRARY_PATH=str(root/'.tools/sysroot/usr/lib')+':/home/rob/.cache/ms-playwright/chromium-1234/chrome-linux64',VK_DRIVER_FILES='/usr/share/vulkan/icd.d/nvidia_icd.json',WGPU_BACKEND='vulkan',XDG_RUNTIME_DIR='/run/user/3000')
